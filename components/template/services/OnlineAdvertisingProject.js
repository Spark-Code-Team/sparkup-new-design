...
const OnlineAdvertisingProject = ()=>{
            ...
            <div className="w-full">
                ...
                <div className="w-[90%] m-auto mt-10">
                    ...
                    <div className="w-full m-auto mt-10">
                        ...
                        <p className="text-[18px] font-bold">نمونه پروژه های تبلیغات آنلاین</p>
                        ...
                        <Swiper pagination={true} modules={[Pagination]} className="mySwiper">
                            ...
                            <SwiperSlide>
                                ...
                                <div className="w-full mt-7">
                                    <Image src="/images/sample-proje.png" alt="" width={392} height={412}/>
...
export default OnlineAdvertisingProject;