                        ...
                        <Swiper pagination={true} modules={[Pagination]} className="mySwiper">
                            ...
                            <SwiperSlide>
                                ...
                                <div className="w-full bg-[#1E1E25] mt-7 pb-10">
                                    ...
                                    <div className="w-full mt-7 text-white pr-5 pl-5">تولید محتوای ویدیویی:  یه ویدیوی باحال و خلاقانه می‌تونه مثل یه جرقه کسب‌وکار شما رو روشن کنه! ما با ساخت ویدیوهای دو بعدی، سه بعدی و موشن گرافیک، باعث می‌شیم همه محو تماشای ویدیوهای شما بشن!
                                        ...
                                        انواع بیلبورد و استرابورد:  بیلبوردهای شما باید تو خیابون خودنمایی کنن! ما بیلبورد و استرابوردهای خلاقانه و جذاب طراحی می‌کنیم که نگاه همه رو به خودشون جذب کنن!</div>
