        ...
        <>
                ...
                <div className="w-full m-auto flex justify-between">
                    ...
                    <div className="lg:w-[393px]">
                        ...
                        <div className="w-full m-auto mt-8 text-white">
                            ...
                            <p className="w-full mt-4">آدرس ایمیل : tripjet@gmail.com</p>
                        </div>
                        ...
                        <div className="w-full m-auto mt-8">
                            ...
                            <iframe
                                ...
                                width="393" height="167" style={{border:"none" , borderRadius:"10px"}} allowFullScreen="" loading="lazy"
                    ...
                    <div className="lg:w-[392px] text-white">
                        ...
                        <div className="w-[392px] h-[38px] m-auto flex gap-x-2 mt-5 pr-3 border-[1.5px] border-[#EDEDED] rounded-lg">
                            ...
                            <div className="w-[33px] h-[38px] flex justify-center items-center">
                                <Image src="/images/user-footer.png" alt="" width={17} height={17}/>
                            </div>

                            <input type="text" name="" className="lg:w-[355px] h-[34px] bg-transparent outline-none focus:ring-0 placeholder:text-[#F9F9F9]" placeholder="نام خود را وارد کنید *"/>
                        ...
                        <div className="w-[392px] h-[38px] m-auto flex gap-x-2 mt-5 pr-3 border-[1.5px] border-[#EDEDED] rounded-lg">
                            ...
                            <div className="w-[33px] h-[38px] flex justify-center items-center">
                                <Image src="/images/email-footer.png" alt="" width={17} height={17}/>
                            </div>

                            <input type="text" name="" className="lg:w-[355px] h-[34px] bg-transparent outline-none focus:ring-0 placeholder:text-[#F9F9F9]" placeholder="ایمیل خود را وارد کنید*"/>
                        ...
                        <div className="w-[392px] h-[38px] m-auto flex gap-x-2 mt-5 pr-3 border-[1.5px] border-[#EDEDED] rounded-lg">
                            ...
                            <div className="w-[33px] h-[38px] flex justify-center items-center">
                                <Image src="/images/tel-footer.png" alt="" width={17} height={17}/>
                            </div>

                            <input type="text" name="" className="lg:w-[355px] h-[34px] bg-transparent outline-none focus:ring-0 placeholder:text-[#F9F9F9]" placeholder="شماره تماس خود را وارد کنید *"/>

                        </div>

                        <button className="w-[392px] h-[38px] bg-[#C1121F] m-auto mt-5 rounded-lg">عضویت در خبرنامه</button>
            ...
            <div className="lg:hidden block w-full bg-[#740B13] text-white mt-10 pt-5 pb-5 pr-5 pl-5">
                ...
                <div className="w-full m-auto mt-10">
                    ...
                    <div className="w-full m-auto mt-7">آدرس ایمیل : tripjet@gmail.com</div>
                ...
                <div className="w-full text-white">
                    ...
                    <button className="w-full h-[38px] bg-[#C1121F] m-auto mt-5 rounded-lg">عضویت در خبرنامه</button>
